...
//
//#undef LOAD_DLL
//	return LoadLibrary(XORS(L"win32u.dll"));
//}
//
//
...
//	if (!pHookFunc)
//	{
//		HMODULE hDll = GetModuleHandle(XORS(L"win32u.dll"));
//		if (!hDll)
//		{
...
//}
//
//bool kernel::driver::write_buffer(uintptr_t addr, void *buffer, size_t size, size_t *transfer)
//{
//	fptr_data::kernel_com com{};
//	com.target_pid = this->pid;
//	com.user_pid = GetCurrentProcessId();
