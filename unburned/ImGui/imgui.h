...
namespace ImGui
{
    ...
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags, bool* rainbow);
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_UseRainbow = 1 << 29,
