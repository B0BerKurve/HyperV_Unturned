...
namespace mono {
	inline mono_root_domain_t* get_root_domain() {
		return reinterpret_cast<mono_root_domain_t*>(memory.read<uintptr_t>(memory.mono /* module handle of mono-2.0-bdwgc.dll */ + 0x719FE8));
	}

	inline void init() { // credits: niceone1 (https://www.unknowncheats.me/forum/3434741-post11.html)
